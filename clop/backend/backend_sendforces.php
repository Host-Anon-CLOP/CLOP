...
EOSQL;
		...
		} else if ($targetnation['age'] < 14 && $mission) {
			$errors[] = "That nation hasn't been active for two weeks.";
		} else if ($nationinfo['age'] < 14) {
			$errors[] = "Your nation hasn't been active for two weeks.";
