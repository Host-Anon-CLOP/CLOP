...
EOSQL;
				$GLOBALS['mysqli']->query($sql);
				$infos[] = "Force en route. {$attackssent['destination_id']} / {$attackssent[0]} / {$attackssent[0][0]} / {$attackssent[0][1]} / {$attackssent[1]} // {$nationinfo['nation_id']} / {$targetnation['nation_id']}";
			}
		}
    }
    if ($_POST['transfer']) {
