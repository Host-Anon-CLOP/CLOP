...
$buildings = array();
$sql = "SELECT n.*, u.user_id, u.username, u.donator, u.alliance_id a.name from nations n, alliances a INNER JOIN users u ON u.user_id = n.user_id WHERE n.nation_id = '{$mysql['nation_id']}' OR u.user_id = '{$mysql['user_id']}'";
