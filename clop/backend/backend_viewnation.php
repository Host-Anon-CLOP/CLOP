...
$buildings = array();
$sql = "SELECT n.*, u.user_id, u.username, u.donator, u.alliance_id from nations n INNER JOIN users u ON u.user_id = n.user_id WHERE n.nation_id = '{$mysql['nation_id']}' INNER JOIN alliances a ON u.alliance_id = a.alliance_id WHERE u.user_id = '{$mysql['user_id']}'";
