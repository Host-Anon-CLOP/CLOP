...
<br/>
<form name="newemail" method="post" action="userinfo.php">
<input type="hidden" name="token_userinfo" value="{$_SESSION['token_userinfo']}"/>
<input type="hidden" name="user_id" value="{$getpost['user_id']}"/>
<center><table>
<tr><td>Email</td><td><input name="email" class="form-control" class="width:200px;" value="{$display['email']}"/></td></tr>
</table></center>
<center><input type="submit" name="changeemail" value="Change Email" class="btn btn-sm btn-warning"/></center>
<br/>
</form>
<form name="newflag" method="post" action="userinfo.php">
<input type="hidden" name="token_userinfo" value="{$_SESSION['token_userinfo']}"/>
<input type="hidden" name="user_id" value="{$getpost['user_id']}"/>
<center><table>
<tr><td>Flag Image URL</td><td><input name="flag" class="form-control" class="width:200px;" value="{$display['flag']}"/></td></tr>
</table></center>
<center><input type="submit" name="changeflag" value="Change Flag" class="btn btn-sm btn-warning"/></center></form>
</form>
<br/>
