...
(3, 3, 'Plow Basic Apples Farm', 'Plow a basic apples-growing farm that uses only horsepower and no modern equipment for -2 sat and 5 apples a tick. Building more than 10 hurts the environment.', 8, 1, 200000, 0, 0, 0, 0, 0, 2, 0),
...
(12, 3, 'Upgrade Apples Farm', 'With 20 vehicle parts and 5 machinery parts, you make your apples farm an easier and more efficient place to work at the cost of regular energy use. (+5 immediate sat; -1 sat, -1 energy, 8 apples per tick) Building more than 20 starts wreaking havoc with the environment.', 16, 1, 200000, 200000, 0, 0, 5, 0, 2, 0),
...
(18, 0, 'Build Coffee Shop', 'Use 40 copper to construct a coffee shop that uses up 3 coffee and 1 pies a tick to increase your ponies'' satisfaction by 10. Raises satisfaction by 5 just being built.', 21, 1, 150000, 150000, 0, 0, 5, 0, 4, 0),
(19, 0, 'Build Bar', 'Use 40 copper to construct a bar that uses up 3 cider and 1 pies a tick to increase your ponies'' satisfaction by 10. Raises satisfaction by 5 just being built.', 22, 1, 150000, 150000, 0, 0, 5, 0, 4, 0),
...
(30, 0, 'Build Video Arcade', 'For 50 copper and 50 energy, you build a video arcade that uses 5 energy and 1 pies a tick to yield 10 satisfaction. Gives 5 satisfaction just being built.', 37, 1, 500000, 500000, 0, 0, 5, 0, 4, 0),
...
(8, 1, 0, 'Basic Apples Farm', 'Growing apples beets or applescane according to the local climate, this Apples Farm produces 5 units of raw apples every 2 hours. It uses nothing but pure horsepower, making it a backbreaking place to work for the local horses.', 0, 0, -2, 0, 1, 10, 10),
...
(16, 1, 0, 'Mechanized Apples Farm', 'Say what you want about the earth pony way, but industrial agriculture definitely beats having to grow the stuff yourself. -1 energy and -1 sat for 8 apples every turn.', 0, 0, -1, 0, 0, 20, 5),
...
(21, 1, 0, 'Coffee Shop', 'This coffee shop uses 3 coffee and 1 pies a turn to provide your ponies with 10 satisfaction. No energy is required.', 0, 0, 10, 0, -10, 0, 0),
(22, 1, 0, 'Bar', 'Unlike bars for humans, this one serves pies with its cider. Uses 3 coffee and 1 pies a turn to provide your ponies with 10 satisfaction. No energy is required.', 0, 0, 10, 0, -10, 0, 0),
...
(37, 1, 0, 'Video Arcade', 'For 50 copper and 50 energy, you build a video arcade that uses 6 energy and 1 pies a turn to yield 10 satisfaction.', 0, 0, 10, 0, -5, 0, 0),
