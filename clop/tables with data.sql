...
(3, 3, 'Plow Basic Apples Orchard', 'Plow a basic apples-growing farm that uses only horsepower and no modern equipment for -2 sat and 5 apples a tick. Building more than 10 hurts the environment.', 8, 1, 200000, 0, 0, 0, 0, 0, 2, 0),
...
(8, 0, 'Distribute Apples', 'Distributing apples to your little ponies is highly inefficient, but at least it gets the job done. Distribute 5 apples for 3 satisfaction.', 0, 0, 0, 0, 0, 0, 3, 0, 1, 0),
(9, 0, 'Distribute Pies', 'Distribute 1 large box of pies to your little ponies to raise their satisfaction by 2.', 0, 0, 0, 0, 0, 0, 2, 0, 1, 0),
...
(12, 3, 'Upgrade Apples Orchard', 'With 20 vehicle parts and 5 machinery parts, you make your Apples Orchard an easier and more efficient place to work at the cost of regular energy use. (+5 immediate sat; -1 sat, -1 energy, 8 apples per tick) Building more than 20 starts wreaking havoc with the environment.', 16, 1, 200000, 200000, 0, 0, 5, 0, 2, 0),
(13, 0, 'Build Bakery', 'Far more efficient than distributing apples directly, the bakery uses 1 energy and 2 apples to make 3 boxes of pies and add 1 satisfaction every tick. Ponies become more satisfied by 2 just watching it be built. Needs 5 copper, 5 energy, 5 vehicle parts, and 5 machinery parts to build.', 12, 1, 400000, 200000, 0, 0, 2, 0, 4, 0),
...
(18, 0, 'Build Coffee Shop', 'Use 40 copper to construct a coffee shop that uses up 3 coffee and 1 pie a tick to increase your ponies'' satisfaction by 10. Raises satisfaction by 5 just being built.', 21, 1, 150000, 150000, 0, 0, 5, 0, 4, 0),
(19, 0, 'Build Bar', 'Use 40 copper to construct a bar that uses up 3 cider and 1 pie a tick to increase your ponies'' satisfaction by 10. Raises satisfaction by 5 just being built.', 22, 1, 150000, 150000, 0, 0, 5, 0, 4, 0),
...
(30, 0, 'Build Video Arcade', 'For 50 copper and 50 energy, you build a video arcade that uses 5 energy and 1 pie a tick to yield 10 satisfaction. Gives 5 satisfaction just being built.', 37, 1, 500000, 500000, 0, 0, 5, 0, 4, 0),
...
(35, 0, 'Build Moon Worship Center', 'For 50 copper and 20 plastics, you build a moon worship center that uses 2 cider and 6 energy to raise your relationship with the New Lunar Republic by 1 every tick.', 40, 1, 300000, 300000, 0, 0, 0, 0, 8, 0),
...
(43, 0, 'Build Toy and Candy Shop', 'For 50 copper, you build a toy and candy shop that gives your ponies 30 satisfaction a tick at the price of 4 apples, 4 pies, and 4 toys. Raises satisfaction by 10 just being built. Really, what kind of adults buy toys?', 48, 1, 400000, 400000, 0, 0, 10, 0, 4, 0),
...
(3, 0, 1, 'Apples', 'A pony without apples is an unhappy pony. Unhappy ponies will overthrow you and trot on your corpse. Keep your ponies happy. Give them apples.', 0, 0, 0, 0, 0, 0, 0),
...
(8, 1, 0, 'Basic Apples Orchard', 'Growing apples beets or applescane according to the local climate, this Apples Orchard produces 5 units of raw apples every 2 hours. It uses nothing but pure horsepower, making it a backbreaking place to work for the local horses.', 0, 0, -2, 0, 1, 10, 10),
...
(12, 1, 0, 'Bakery', 'Every turn, this bakery performs the vital task of turning 1 unit of energy and 2 of apples into 3 huge boxes of pies. It''s also a great place to work.', 0, 0, 1, 0, -5, 0, 0),
(13, 0, 1, 'Pies', 'Distributing these baked treats brings your little ponies'' happiness up quickly.', 0, 0, 0, 0, 0, 0, 0),
...
(16, 1, 0, 'Mechanized Apples Orchard', 'Say what you want about the earth pony way, but industrial agriculture definitely beats having to grow the stuff yourself. -1 energy and -1 sat for 8 apples every turn.', 0, 0, -1, 0, 0, 20, 5),
(17, 1, 0, 'Cider Production Facility', 'Ferment 5 apples a turn into 5 cider! Requires 15 copper, 5 vehicle parts, and 5 mechanical parts to build. Does nothing for satisfaction one way or another, as the ponies working there are high on their own supply.', 0, 0, 0, 0, 0, 0, 0),
(18, 0, 1, 'Cider', 'Serve it in bars or fuel your communists with it.', 0, 0, 0, 0, 0, 0, 0),
...
(21, 1, 0, 'Coffee Shop', 'This coffee shop uses 3 coffee and 1 pie a turn to provide your ponies with 10 satisfaction. No energy is required.', 0, 0, 10, 0, -10, 0, 0),
(22, 1, 0, 'Bar', 'Unlike bars for humans, this one serves pies with its cider. Uses 3 coffee and 1 pie a turn to provide your ponies with 10 satisfaction. No energy is required.', 0, 0, 10, 0, -10, 0, 0),
...
(37, 1, 0, 'Video Arcade', 'For 50 copper and 50 energy, you build a video arcade that uses 6 energy and 1 pie a turn to yield 10 satisfaction.', 0, 0, 10, 0, -5, 0, 0),
...
(40, 1, 0, 'Moon Worship Center', 'For 50 copper and 20 plastics, you build a moon worship center that uses 2 cider and 6 energy to raise your relationship with the New Lunar Republic by 1 every turn.', 0, 1, 0, 0, 0, 0, 0),
...
(48, 1, 0, 'Toy and Candy Shop', 'For 50 copper, you build a toy and candy shop that gives your ponies 30 satisfaction a turn at the price of 4 apples, 4 pies, and 4 toys. Raises satisfaction by 10 just being built. Really, what kind of adults buy toys?', 0, 0, 30, 0, -20, 0, 0),
