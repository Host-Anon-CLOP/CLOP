...
(3, 3, 'Plow Basic Apple Orchard', 'Plow a basic apple-growing orchard that uses only horsepower and no modern equipment for -2 sat and 5 apples a tick. Building more than 10 hurts the environment.', 8, 1, 200000, 0, 0, 0, 0, 0, 2, 0),
...
(12, 3, 'Upgrade Apple Orchard', 'With 20 vehicle parts and 5 machinery parts, you make your Apple Orchard an easier and more efficient place to work at the cost of regular energy use. (+5 immediate sat; -1 sat, -1 energy, 8 apples per tick) Building more than 20 starts wreaking havoc with the environment.', 16, 1, 200000, 200000, 0, 0, 5, 0, 2, 0),
...
(8, 1, 0, 'Basic Apple Orchard', 'Growing apple according to the local climate, this Apple Orchard produces 5 units of raw apples every 2 hours. It uses nothing but pure horsepower, making it a backbreaking place to work for the local horses.', 0, 0, -2, 0, 1, 10, 10),
...
(16, 1, 0, 'Mechanized Apple Orchard', 'Say what you want about the earth pony way, but industrial agriculture definitely beats having to grow the stuff yourself. -1 energy and -1 sat for 8 apples every turn.', 0, 0, -1, 0, 0, 20, 5),
