...
(3, 3, 'Plow Basic Apple Farm', 'Plow a basic apple-growing farm that uses only horsepower and no modern equipment for -2 sat and 5 apples a tick. Building more than 10 hurts the environment.', 8, 1, 200000, 0, 0, 0, 0, 0, 2, 0),
...
(12, 3, 'Upgrade Apple Farm', 'With 20 vehicle parts and 5 machinery parts, you make your Apple Farm an easier and more efficient place to work at the cost of regular energy use. (+5 immediate sat; -1 sat, -1 energy, 8 apples per tick) Building more than 20 starts wreaking havoc with the environment.', 16, 1, 200000, 200000, 0, 0, 5, 0, 2, 0),
